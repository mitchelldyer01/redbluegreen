...
The binary `rbg` (src/main.rs) talks to the kfd driver: it prints
the uapi version, gpu_id and gfx target, and can call ACQUIRE_VM.
...
first five build units. Unit 1 is done; unit 2 is next.
